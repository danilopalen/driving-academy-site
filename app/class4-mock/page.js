...
const MockTestClass4 = () => {
  const router = useRouter();
  const [isOpen, setIsOpen] = useState(false);
  const handleClose = () => setIsOpen(false);
  const handleContinue = (region) => {
    setIsOpen(false);
    router.push(`/book?service=class-4-mock&region=${region}`);
  };
  const handleBookNow = () => {
    setIsOpen(true);
  };
      ...
      <div className="container">
        ...
        <header className="header">
          <h1 className="title">
            ...
            Class 4 Mock Driving Test
          </h1>
          <p className="description">
            Our 1-hour Class 4 mock tests are for someone who is preparing for
            their full license licence test. During the mock driving test, our
            instructor will carry the driving assessment grid and assess your
            driving skills exactly like how a driving testing officer conducts a
            driving test at the testing station.
          </p>
        </header>
        ...
        <div className="content-grid">
          <div className="card">
            <div className="pricing-card">
              ...
              <p className="info-notice">
                This price is all-inclusive. We’re more than happy to provide
                door-to-door service to meet your needs.
              </p>
            </div>

            <div className="warning-notice">
              <p>
                Additional cost: Our driving school does not have any class 4
                vehicles. We can organise a truck hire at an additional cost, or
                you can supply your truck for the mock test. Please contact us
                to learn more. There is no additional charge for those who can
                supply their truck.
              </p>
            </div>
            ...
            <div style={{ marginTop: "2rem" }}>
              ...
              <p style={{ color: "#4b5563" }}>
                The person who is taking this lesson must have a Class 4 learner
                licence or above.
              </p>
            </div>
          </div>
          ...
          <div className="card">
            ...
            <p>
              This one-hour simulated driving assessment test with a NZTA
              qualified Driving Instructor ​is comprised of four parts:
            </p>
            <br />
