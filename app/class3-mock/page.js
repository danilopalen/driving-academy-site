...
const MockTestClass3 = () => {
  const router = useRouter();
  const [isOpen, setIsOpen] = useState(false);
  const handleClose = () => setIsOpen(false);
  const handleContinue = (region) => {
    setIsOpen(false);
    router.push(`/book?service=class-3-mock&region=${region}`);
  };
  const handleBookNow = () => {
    setIsOpen(true);
  };
      ...
      <div className="container">
        ...
        <header className="header">
          <h1 className="title">
            ...
            Class 3 Mock Driving Test
          </h1>
          <p className="description">
            Our 1-hour Class 3 tests are for someone who is preparing for their
            full license licence test. During the mock driving test, our
        ...
        <div className="content-grid">
          <div className="card">
            ...
            <div className="warning-notice">
              <p>
                Additional cost: Our driving school does not have any class 3
                vehicles. Class 3 mock test can only be conducted in your own
                truck. There is no additional charge for those who can supply
                their truck. Please contact us to learn more.
              </p>
            </div>
            ...
            <div style={{ marginTop: "2rem" }}>
              ...
              <p style={{ color: "#4b5563" }}>
                The person who is taking this lesson must have a Class 3 learner
                licence or above.
              </p>
            </div>
          </div>
