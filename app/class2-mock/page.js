...
const MockTestClass2 = () => {
  const router = useRouter();
  const [isOpen, setIsOpen] = useState(false);
  const handleClose = () => setIsOpen(false);
  const handleContinue = (region) => {
    setIsOpen(false);
    router.push(`/book?service=class-2-mock&region=${region}`);
  };
  const handleBookNow = () => {
    setIsOpen(true);
  };
      ...
      <div className="container">
        ...
        <header className="header">
          <h1 className="title">
            ...
            Class 2 Mock Driving Test
          </h1>
          <p className="description">
            Our 1-hour Class 2 tests are for someone who is preparing for their
        ...
        <div className="content-grid">
          <div className="card">
            ...
            <div className="warning-notice">
              <p>
                Additional cost: Our driving school does not have any class 2
