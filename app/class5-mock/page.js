...
const MockTestClass5 = () => {
  const router = useRouter();
  const [isOpen, setIsOpen] = useState(false);
  const handleClose = () => setIsOpen(false);
  const handleContinue = (region) => {
    setIsOpen(false);
    router.push(`/book?service=class-5-mock&region=${region}`);
  };
  const handleBookNow = () => {
    setIsOpen(true);
  };
      ...
      <div className="container">
        ...
        <header className="header">
          <h1 className="title">
            ...
            Class 5 Mock Driving Test
          </h1>
          <p className="description">
            Our 1-hour Class 5 mock tests are for someone who is preparing for
        ...
        <div className="content-grid">
          <div className="card">
            ...
            <div className="warning-notice">
              <p>
                Additional cost: Our driving school does not have any class 5
