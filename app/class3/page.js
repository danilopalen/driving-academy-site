...
const Class3Page = () => {
  ...
  const handleContinue = (region) => {
    setIsOpen(false);
    router.push(`/book?service=class-3&region=${region}`);
  };
  const handleBookNow = () => {
    setIsOpen(true);
  };
      ...
      <div className="container">
        ...
        <header className="header">
          ...
          <p className="description">
            Our 1-hour Class 3 lessons are for Class 3 learner licence holders.
          ...
          <div className="notice">
            ...
            <p className="notice-text">
              We are unable to organise a truck hire for class 3 driving
              lessons. You can only conduct class 3 driving lessons in your own
              truck.
            </p>
          </div>
        </header>
          ...
          <div className="card">
            <div className="pricing-card">
              ...
              <div className="price-note">
                ...
                />
                <p>
                  Our driving school does not have any class 3 vehicles. Class 3
